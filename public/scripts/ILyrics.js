class InteractiveLyrics {
    ...
    constructor() {
        this._content = [
            ...
            "Let's start from scratch", "Let's build the home", 'The home of our imagination', "There won't be guns", "There won't be walls", "There won't be any countries or nations", "Just you and me", "In our new world", "In our new world", "In the universe", "I want to fly", "Far away from civilization", "Please come with me", "And take my hand", "Let's abandon this constellation", "Quiero volar", "In the universe I want to fly", 'Far away from civilization', 'Quiero volar', 'Please come with me', 'And take my hand', "Let's abandon this constellation", 'Quiero volar', 'In the universe I want to fly', "Far away from civilization", "Quiero volar", "Please come with me", 'And take my hand', "Let's abandon this constellation", "Quiero volar", 'In the universe I want to fly', 'Far away from civilization', 'Quiero volar', 'Please come with me', 'And take my hand', "Let's abandon this constellation", 'Quiero volar', 'IN', 'THE', 'UNIVERSE ', 'I', 'WANT', 'TO', 'FLY', 'FAR', 'AWAY', 'FROM', 'CIVILIZATION', 'PLEASE', 'COME', 'WITH', 'ME', 'AND', 'TAKE', 'MY', 'HAND', "LET'S", 'ABANDON', 'THIS', 'CONSTELLATION', 'Fly', 'In the universe', 'I want to', 'Fly', 'There is no war ', 'There is no', 'Crime', 'Please come with me and take my ', 'Hand', 'Sal ahora mismo y déjalo', 'Vente al universo conmigo', 'Escápate y olvídalo', 'Vente al universo conmigo', 'Prepárate y vámonos', 'Vente al universo conmigo', 'Quiero volar', 'IN', 'THE', 'UNIVERSE', 'I ', 'WANT', 'TO', 'FLY', 'FAR', 'AWAY', 'FROM', 'CIVILIZATION', 'Quiero volar', 'PLEASE', 'COME', 'WITH', 'ME', 'AND', 'TAKE', 'MY', 'HAND', "LET'S", 'ABANDON', 'THIS', 'CONSTELLATION', 'Quiero volar', 'In the universe I want to fly', 'Far away from civilization', 'Quiero volar', 'Please come with me ', 'And take my hand', "Let's abandon this constellation", 'Quiero volar',  'In the universe I want to fly', 'Far away from civilization', 'Quiero volar', 'Please come with me ', 'And take my hand', 
            "Let's abandon this constellation"
        ]
